...
export const HeroSection = () => {
  const highlights = [{
    ...
    icon: CheckCircle,
    label: '700+',
    subtitle: 'JEE Success'
  }, {
    icon: CheckCircle,
    label: '800+',
    subtitle: 'NEET Success'
  }];
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-white space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button size="lg" variant="secondary" className="text-lg px-8 py-4 shadow-hero">
                Book Demo Class
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 pt-8">
              {highlights.map((item, index) => <div key={index} className="text-center">
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 shadow-hero">
                <div className="bg-white rounded-xl p-6 space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    rank: 'AIR 67',
                    score: '710/720'
                  }].map((student, idx) => <div key={idx} className="flex justify-between items-center p-3 bg-gradient-subtle rounded-lg">
                        <div>
