...
export const Footer = () => {
  ...
  const courses = [
    { label: 'NEET Foundation', href: '#neet-foundation' },
    { label: 'JEE Main + Advanced', href: '#jee-advanced' },
    { label: 'NEET Dropper', href: '#neet-dropper' },
    { label: 'JEE Crash Course', href: '#jee-crash' },
  ];

  const resources = [
    { label: 'Free Study Material', href: '#free-material' },
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-blue-100 mb-4">
                India's trusted NEET & JEE coaching institute with 15+ years of excellence in medical and engineering entrance preparation.
              </p>
            </div>
